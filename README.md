...
- **Nikola TEST MCP Website**: [https://petstore.swagger.io/](https://petstore.swagger.io/)
- **API Documentation**: []()
...
1. Clone this repository:
   ```bash
   git clone https://github.com/Traia-IO/nikola-test-mcp-mcp-server.git
   cd nikola-test-mcp-mcp-server
   ```
...
1. Create API client functions for Nikola TEST MCP endpoints
